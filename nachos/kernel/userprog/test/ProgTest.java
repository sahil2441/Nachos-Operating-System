...
/**
 * This is a test class for demonstrating that Nachos can load a user program
 * and execute it.
 * 
...
public class ProgTest implements Runnable {
	...
	Nachos.options.processOptions(new Options.Spec[] {
		new Options.Spec("-x", new Class[] { String.class },
			"Usage: -x <executable file>", new Options.Action() {
