...
class OpenFileReal implements OpenFile {
	...
	// take updated value of file length
	...
	System.arraycopy(from, index, buf,
		(int) position - (firstSector * diskSectorSize), numBytes);

	// write modified sectors back
	for (i = firstSector; i <= lastSector; i++)
	    filesystem.writeSector(hdr.byteToSector(i * diskSectorSize), buf,
		    (i - firstSector) * diskSectorSize);
