...
/**
 * This "stub" class implements file operations for Nachos by simply passing the
 * filesystem operations through to the native filesystem on the host platform.
 * This is provided in case the multiprogramming and virtual memory assignments
 * (which make use of the file system) are done before the file system
 * assignment.
 * 
...
class OpenFileStub implements OpenFile {
     ...
     *
     * @param f
     *            The underlying file on the host filesystem.
     */
