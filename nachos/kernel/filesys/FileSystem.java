 ...
 * (Openfile.java).
 *
 * We define two separate implementations of the file system: a "real" file
 * system, built on top of a disk simulator, and a "stub" file system, which
 * just re-defines the Nachos file system operations as operations on the native
 * file system on the machine running the Nachos simulation.
 * 
...
public abstract class FileSystem {
     ...
     * @return
     */
    public abstract boolean createDirectory(String pathName);

    // Added
    /**
     * Removes a directory. Called from Rmdir syscall.
     * 
     * @param pathName
     * @return
     */
    ...
    /**
     * Protected constructor to force creation of a filesystem using the init()
     * factory method.
     */
    ...
    /**
     * Factory method to create the proper type of filesystem and hide the type
     * actually being used.
     * 
     * @param disk
     *            Disk driver to use to access the filesystem.
     */
    ...
    /**
     * List contents of the filesystem directory (for debugging). This is only
     * implemented by the real filesystem.
     */
    public void list() {
    }

    /**
     * Print contents of the entire filesystem (for debugging). This is only
     * implemented by the real filesystem.
     */
    public void print() {
    }
     ...
     *
     * @param buffer
     *            The buffer from which the value is to be deserialized.
     * @param pos
     *            Starting offset from the beginning of the buffer at which the
     *            serialized bytes representing the value exist.
     ...
     *
     * @param val
     *            The integer value to be serialized.
     * @param buffer
     *            The buffer into which the value is to be serialized.
     * @param pos
     *            Starting offset from the beginning of the buffer at which the
     *            serialized bytes representing the value are to be placed.
     */
